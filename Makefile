...
test_Iphone11_13:
	robot --variable deviceName:"iPhone 11" --variable platformName:"iOS" --variable browserName:safari --variable platformVersion:"11.1" --variable ROBOT_BROWSER:chrome --variable isRealMobile:true --variable visual:false --variable network:false --variable console:false Tests/inputno.robot
